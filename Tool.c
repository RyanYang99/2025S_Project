...
const color_tchar_t pWooden_sword[TEXTURE_SIZE][TEXTURE_SIZE] = {
    ...
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_YELLOW }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_YELLOW }, { ' ', 0, BACKGROUND_T_TRANSPARENT } },
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_YELLOW }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', 0, BACKGROUND_T_TRANSPARENT } },
    { { ' ', 0, BACKGROUND_T_TRANSPARENT }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', 0, BACKGROUND_T_TRANSPARENT } }
