...
const color_tchar_t pWooden_sword[TEXTURE_SIZE][TEXTURE_SIZE] = {
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
}, pStone_sword[TEXTURE_SIZE][TEXTURE_SIZE] = {
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_GRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_GRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
}, pIron_sword[TEXTURE_SIZE][TEXTURE_SIZE] = {
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
    ...
    { { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
}, pWooden_axe[TEXTURE_SIZE][TEXTURE_SIZE] = {
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
}, pStone_axe[TEXTURE_SIZE][TEXTURE_SIZE] = {
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_GRAY }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_GRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_GRAY }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
}, pIron_axe[TEXTURE_SIZE][TEXTURE_SIZE] = {
    { { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_DARKGRAY, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
