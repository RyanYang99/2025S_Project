...
const color_tchar_t pWooden_sword[TEXTURE_SIZE][TEXTURE_SIZE] = {
    ...
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ',FOREGROUND_T_BLACK, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
    ...
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', 0, BACKGROUND_T_TRANSPARENT }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
    ...
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKGRAY }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } },
    { { ' ', FOREGROUND_T_TRANSPARENT, 0 }, { ' ', FOREGROUND_T_BLACK, BACKGROUND_T_DARKYELLOW }, { ' ', FOREGROUND_T_TRANSPARENT, 0 } }
